...
export const Footer = () => {
  return (
    ...
    <a href="https://www.linkedin.com/in/mohamed-mahmoud-75bba4291/"><BsLinkedin   className="icon"/></a>
    ...
    <div>
    <p>© 2023 <a href="https://www.linkedin.com/in/mohamed-mahmoud-75bba4291/">Mohamed Mahomud</a>. All rights reserved.</p>
    </div>
    </footer>
  )
}
