      ...
      <div className="flex" style={{justifyContent: "space-between" , }}>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="textarea flex" style={{ marginTop: "25px" ,alignItems:"center" }}>
            ...
            <textarea required name="message" id="message" placeholder="Enter Message ..."></textarea>
            <ValidationError 
            prefix="Message" 
            field="message"
            errors={state.errors}
...
{state.succeeded && (<p  style={{marginTop:".5rem" ,fontSize:"20px" ,display:"flex" ,alignItems:"center"}}> 
...
The message was sent successfully 👌</p>)}
        </form>
